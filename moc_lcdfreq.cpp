...
void LCDFreq::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        LCDFreq *_t = static_cast<LCDFreq *>(_o);
        switch (_id) {
        case 0: _t->tuneStep((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->tune3((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData LCDFreq::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject LCDFreq::staticMetaObject = {
    { &QLCDNumber::staticMetaObject, qt_meta_stringdata_LCDFreq,
      qt_meta_data_LCDFreq, &staticMetaObjectExtraData }
};
