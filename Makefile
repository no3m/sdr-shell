...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sat Mar 7 01:27:31 2020
# Project:  sdr-shell.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -o Makefile sdr-shell.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib `pkg-config --cflags --libs hamlib` -lQtGui -lQtNetwork -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: sdr-shell.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/sdr-shell1.0.0/ && $(COPY_FILE) --parents main_widget.h spectrogram.h varilabel.h memorycell.h pbscale.h spectrum.h text.h hamlibwrapper.h rigctl.h dttsp.h lcdfreq.h command.h idbutton.h palettes.h .tmp/sdr-shell1.0.0/ && $(COPY_FILE) --parents main.cpp main_widget.cpp spectrogram.cpp varilabel.cpp memorycell.cpp spectrum.cpp hamlibwrapper.cpp rigctl.cpp pbscale.cpp dttsp.cpp lcdfreq.cpp command.cpp idbutton.cpp .tmp/sdr-shell1.0.0/ && (cd `dirname .tmp/sdr-shell1.0.0` && $(TAR) sdr-shell1.0.0.tar sdr-shell1.0.0 && $(COMPRESS) sdr-shell1.0.0.tar) && $(MOVE) `dirname .tmp/sdr-shell1.0.0`/sdr-shell1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/sdr-shell1.0.0
...
compiler_moc_header_make_all: moc_main_widget.cpp moc_spectrogram.cpp moc_varilabel.cpp moc_memorycell.cpp moc_pbscale.cpp moc_spectrum.cpp moc_hamlibwrapper.cpp moc_rigctl.cpp moc_lcdfreq.cpp moc_command.cpp moc_idbutton.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_main_widget.cpp moc_spectrogram.cpp moc_varilabel.cpp moc_memorycell.cpp moc_pbscale.cpp moc_spectrum.cpp moc_hamlibwrapper.cpp moc_rigctl.cpp moc_lcdfreq.cpp moc_command.cpp moc_idbutton.cpp
moc_main_widget.cpp: spectrogram.h \
		...
		idbutton.h \
		main_widget.h
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) main_widget.h -o moc_main_widget.cpp

moc_spectrogram.cpp: spectrogram.h
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) spectrogram.h -o moc_spectrogram.cpp

moc_varilabel.cpp: varilabel.h
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) varilabel.h -o moc_varilabel.cpp

moc_memorycell.cpp: memorycell.h
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) memorycell.h -o moc_memorycell.cpp

moc_pbscale.cpp: pbscale.h
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) pbscale.h -o moc_pbscale.cpp

moc_spectrum.cpp: spectrum.h
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) spectrum.h -o moc_spectrum.cpp

moc_hamlibwrapper.cpp: hamlibwrapper.h
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) hamlibwrapper.h -o moc_hamlibwrapper.cpp

moc_rigctl.cpp: rigctl.h
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) rigctl.h -o moc_rigctl.cpp

moc_lcdfreq.cpp: lcdfreq.h
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) lcdfreq.h -o moc_lcdfreq.cpp

moc_command.cpp: dttsp.h \
		command.h
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) command.h -o moc_command.cpp

moc_idbutton.cpp: idbutton.h
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) idbutton.h -o moc_idbutton.cpp
...
rigctl.o: rigctl.cpp main_widget.h \
		spectrogram.h \
		spectrum.h \
		varilabel.h \
		memorycell.h \
		...
		command.h \
		idbutton.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o rigctl.o rigctl.cpp
...
moc_rigctl.o: moc_rigctl.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_rigctl.o moc_rigctl.cpp
