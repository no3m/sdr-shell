...
static const char qt_meta_stringdata_RigCtlSocket[] = {
    "RigCtlSocket\0\0disconnected()\0readyRead()\0"
};
...
const QMetaObjectExtraData RigCtlSocket::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject RigCtlSocket::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_RigCtlSocket,
      qt_meta_data_RigCtlSocket, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &RigCtlSocket::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RigCtlSocket))
...
static const char qt_meta_stringdata_RigCtlServer[] = {
    "RigCtlServer\0\0newConnection()\0"
};
...
const QMetaObjectExtraData RigCtlServer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject RigCtlServer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_RigCtlServer,
      qt_meta_data_RigCtlServer, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &RigCtlServer::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RigCtlServer))
