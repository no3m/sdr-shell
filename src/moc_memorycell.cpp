...
void MemoryCell::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        MemoryCell *_t = static_cast<MemoryCell *>(_o);
        switch (_id) {
        case 0: _t->read((*reinterpret_cast< MemoryCell*(*)>(_a[1]))); break;
        case 1: _t->write((*reinterpret_cast< MemoryCell*(*)>(_a[1]))); break;
        case 2: _t->display((*reinterpret_cast< MemoryCell*(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData MemoryCell::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MemoryCell::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_MemoryCell,
      qt_meta_data_MemoryCell, &staticMetaObjectExtraData }
};
