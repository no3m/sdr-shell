...
void Spectrogram::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->tune1((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->tune2((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->tune3((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->plot((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->movement((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData Spectrogram::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Spectrogram::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Spectrogram,
      qt_meta_data_Spectrogram, &staticMetaObjectExtraData }
};
