/****************************************************************************
** Meta object code from reading C++ file 'idbutton.h'
**
...
#error "The header file 'idbutton.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_IdPushButton[] = {
    "IdPushButton\0\0selected(int)\0nclick()\0"
};
...
const QMetaObject IdPushButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_IdPushButton,
...
// SIGNAL 0
void IdPushButton::selected(int _t1)
{
